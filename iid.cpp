...
#ifdef NTDDI_WIN10
// Known limitation: Check if any of these require a minimum 10.x SDK version
#include <d3d12.h>
#include <dxgi1_5.h>
#include <d3d11_4.h>
#endif
...
DEFINE_GUID(IID_SpecialKD3D11DeviceContext, 0xe8a22a3f, 0x1405, 0x424c, 0xae, 0x99, 0x0d, 0x3e, 0x9d, 0x54, 0x7c,
            0x32); // Returns the unwrapped device
...
static const struct IID_name known_interfaces[] = {
    ...
    IID(IDXGIFactory1),
    IID(IDXGIFactory2),
    // Known limitation: IID_IDXGIFactory6, Supposed to be in dxgi1_6.h, but not present in SDK 10.0.16299.0
    IID(IDXGIInfoQueue),
    IID(IDXGIKeyedMutex),
    IID(IDXGIObject),
    IID(IDXGIOutput),
