...
extern "C" HRESULT(__stdcall *fnOrigCreateDXGIFactory)(REFIID riid, _Out_ void **ppFactory);

extern "C" HRESULT(__stdcall *fnOrigCreateDXGIFactory1)(REFIID riid, _Out_ void **ppFactory);

extern "C" HRESULT(__stdcall *fnOrigCreateDXGIFactory2)(UINT Flags, REFIID riid, _Out_ void **ppFactory);
