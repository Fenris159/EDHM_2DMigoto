...
class HackerDevice : public ID3D11Device1
{
  private:
	...
	char *_ReplaceShaderFromShaderFixes(UINT64 hash, const wchar_t *shaderType, const void *pShaderBytecode,
	                                    ...
	                                    FILETIME &timeStamp, wstring &headerLine, const char *overrideShaderModel);
	...
	template <class ID3D11Shader, HRESULT (__stdcall ID3D11Device::*OrigCreateShader)(
	                                  THIS_ __in const void *pShaderBytecode, __in SIZE_T BytecodeLength,
	                                  __in_opt ID3D11ClassLinkage *pClassLinkage, __out_opt ID3D11Shader **ppShader)>
	void KeepOriginalShader(UINT64 hash, const wchar_t *shaderType, ID3D11Shader *pShader, const void *pShaderBytecode,
