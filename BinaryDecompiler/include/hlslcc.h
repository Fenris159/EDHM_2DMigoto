...
struct ShaderVarType
{
	...
	ShaderVarType(ShaderVarType &&other) noexcept
	    : Class(other.Class), Type(other.Type), Rows(other.Rows), Columns(other.Columns), Elements(other.Elements),
	      MemberCount(other.MemberCount), Offset(other.Offset), Name(std::move(other.Name)),
	      ParentCount(other.ParentCount), Parent(other.Parent), FullName(std::move(other.FullName)),
